...
int main( int argc, char** argv )
{
    ...
    // 读取图片，生成Frame 的 cv:Mat 数据
    FRAME lastFrame = readFrame( currIndex, pd ); // 上一帧数据
    // 我们总是在比较currFrame和lastFrame  目前不用，直接使用 ORB 描述子
    ...
    pcl::io::savePCDFile( "/home/xiaolinz/uisee_blog/test/3rdparty_test/rgbd_slam/source/result.pcd", *cloud );
    return 0;
}
